...
from GriddedCalibSite_NMF import GriddedCalibSite
    ...
    params = [
        {
            ...
            # 'Guess': 10.3674359858666, #panjane
            'Guess': 9.842814535, #motaze
            'Min': 9,
            'Max': 11.5
        },
        {
            ...
            # 'Guess': 10.6145353631319,
            'Guess': 10.5315271872497,
            'Min': 8.5,
            'Max': 11
        }
    ]
