...
if __name__=="__main__":
    ...
    local_trips_hist, bins = np.histogram(local_by_person, bins=np.arange(80))
    regional_trips_hist, bins = np.histogram(regional_by_person, bins=np.arange(80))
    ...
    plt.figure()
    plt.suptitle("x_Local_Migration = 4.0, x_Regional_Migration = 0.03")
    ax = plt.subplot(211)
